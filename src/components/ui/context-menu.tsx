...
// @ts-expect-error -- pragmatic: @radix-ui/react-context-menu is not installed (unused shadcn stub; import/no-unresolved is likewise disabled for this directory)
